...
class Itemdetailcamera extends StatelessWidget {
  const Itemdetailcamera ({Key? key}) : super(key: key);
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(context, '/Itemdetailcamera');
                      },
                      child: Text(
                        'Buy Now',
                        style: TextStyle(
